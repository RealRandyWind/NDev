...
namespace NDev
{
	...
	struct TArray
	{
		...
		operator TArray<SizeLhs, TypeLhs>()
		{
			TArray<SizeLhs, TypeLhs> Lhs;
			FSize Index, End;
		...
		TArray<SizeData, TypeValue> & operator=(const TypeRhs &Rhs)
		{
			FSize Index, End;
		...
		TArray<SizeData, TypeValue> & operator=(const TArray<SizeRhs, TypRhs> &Rhs)
		{
			FSize Index, End;
		...
		static TArray<SizeRhs, TypeValue> Like()
		{
			TArray<SizeRhs, TypeValue> Result;
			return Result;
		}

		template<typename TypeRhs>
		static TArray<SizeData, TypeRhs> Like()
		{
			TArray<SizeData, TypeRhs> Result;
			return Result;
		}
	};
